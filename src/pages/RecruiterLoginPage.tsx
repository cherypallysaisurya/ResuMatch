...
import { FileText, CheckCircle, Shield, Zap, Search } from "lucide-react";
        ...
        >
          <div className="text-left text-white">
            ...
            >
              ...
              <h1 className="text-3xl font-bold ml-3 bg-gradient-to-r from-blue-300 to-blue-500 bg-clip-text text-transparent">
                Recruiter Portal
              </h1>
            </motion.div>
